...
clickhouse-client -u default --password 123456 --database testdb
SHOW TABLES;
clickhouse-client -u default --password 123456 --database=testdb --multiquery < /docker-entrypoint-initdb.d/clickhouse-init.sql